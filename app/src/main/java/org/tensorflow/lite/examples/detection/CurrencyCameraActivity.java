...
import org.tensorflow.lite.examples.detection.tflite.currencyClassifier.Recognition;

public abstract class CurrencyCameraActivity extends AppCompatActivity
          ...
          CameraConnectionFragment.newInstance(
              new CameraConnectionFragment.ConnectionCallback() {
                ...
                public void onPreviewSizeChosen(final Size size, final int rotation) {
                  ...
                  CurrencyCameraActivity.this.onPreviewSizeChosen(size, rotation);
                }
              },
              this,
              getLayoutId(),
